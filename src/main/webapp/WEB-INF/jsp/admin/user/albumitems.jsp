            ...
            <div class="card">
                <div class="card-header">
                   ...
                    ...
                    <div class="card-body">
                        <div class="row">
                            <c:forEach items="${photos}" var="po">
                                <div class="card" style="width: 18rem;">
                                    <img class="card-img-top p-2 w-100s h-50" src="${pageContext.request.contextPath}/${po.url}" alt="Card image cap">
                                    <div class="card-body">
                                        <h5 class="card-title">---------</h5>
                                        <p class="card-text"><fmt:formatDate value="${po.createDate}" pattern="yyyy-MM-dd HH.mm.ss" /></p>
